...
final class UpdateDeviceSpecData extends Data
{
    /**
     * @param array<string, mixed>|Optional $additional_specs
     */
    public function __construct(
        public readonly string|Optional $category,
        public readonly string|Optional $brand,
        public readonly string|Optional $model,
        public readonly int|Optional $warranty_months,
